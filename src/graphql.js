...
const dbConnectionString = process.env.MONGODB_URI || (process.env.MONGODB_CONNECTION + process.env.MONGODB);
...
const NodeSchema = new mongoose.Schema({
  ...
  // - enables nodeId to build paths, without having to store/display the content
  // - when removing a child, also removes parent where placeholder=true
  placeholder: {
    type: Boolean,
    default: false,
  },
...
const newNode = (tmpRecord) => {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    let record = {
      ...
      placeholder: tmpRecord.hasOwnProperty('placeholder') ? tmpRecord.placeholder : undefined,
      active: true,
